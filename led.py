...
white = GPIO.PWM(24, 100)    # create object white for PWM on port 25 at 100 Hertz  
red = GPIO.PWM(25, 100)      # create object red for PWM on port 24 at 100 Hertz  
...
pause_time = 0.04           # you can change this to slow down/speed up  
